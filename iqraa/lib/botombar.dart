...
import 'package:al_quran/playeraudio.dart';
            ...
            children: <Widget>[
              IconButton(
                ...
                icon: Icon(
                  ...
                  color:
                      selectedIndex == 0 ? Colors.green : Colors.grey.shade400,
                ),
              ),
              IconButton(
                onPressed: () {
                ...
                icon: Icon(
                  Icons.library_books,
                  color:
                      selectedIndex == 1 ? Colors.green : Colors.grey.shade400,
                ),
              ),
              ...
              IconButton(
                ...
                icon: Icon(
                  ...
                  color:
                      selectedIndex == 2 ? Colors.green : Colors.grey.shade400,
                ),
              ),
              const SizedBox(
                width: 50.0,
